function [W1,Wp,Clist_GT,Wm, X,  threshold_GT] = sampling_ind_reg(subject_num, N, sigma0, f2, DF, cluster_size, rho_in, rho_out)
...
[Z,Z_cell] = pick_idx(cluster_size, N);
...
R2_vec = f2/ (1 + f2)*ones(1,edge_num);
